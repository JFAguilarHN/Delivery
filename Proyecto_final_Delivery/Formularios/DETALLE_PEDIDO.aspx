<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="DETALLE_PEDIDO.aspx.cs" Inherits="Formulario_de_clase.FORMULARIOS.MAESTROS.DETALLE_PEDIDO" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_cancelar" runat="server" BackColor="#E91818" Font-Size="Large" ForeColor="White" Text="CANCELAR" OnClick="btn_cancelar_Click" />
    </p>
    <p>
    </p>
</asp:Content>
